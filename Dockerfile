...
CMD python patch_loading.py && python fix_media_ytdlp.py && python fix_youtube_ytdlp_fallback.py && gunicorn app:app --bind 0.0.0.0:${PORT} --workers 1 --threads 4 --timeout 300
